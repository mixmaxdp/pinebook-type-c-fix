...
# to receive power and enumerate without needing pull-down resistors.
#
# When a PD source (charger/dock) is connected, host mode is disabled so the
# Type-C Port Manager can negotiate power delivery normally.
